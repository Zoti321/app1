...
internal object OpenMeteoApiFactory {
    ...
    fun createOpenMeteoApi(
        ...
        val geocodingApi = createRetrofit(geocodingBaseUrl, okHttpClient, json)
            .create(GeocodingApi::class.java)
        val forecastApi = createRetrofit(forecastBaseUrl, okHttpClient, json)
